...
public class CatalogoPrecios extends Conexion{
    ...
    public static boolean  InsertarPrecio(Precios miPrecio) throws Exception{
        boolean resultado=false;
         ...
         try{
               ...
               ObjProcedimiento.setFloat(2,miPrecio.getIdPrecio());
         ...
         {
             JOptionPane.showMessageDialog(null,"Error en Catalogo: InsertarPrecios "+pp.getMessage(),"ATENCION",JOptionPane.WARNING_MESSAGE);
         }finally{
             conector.close();
         }
    ...
    public static boolean  EliminarPrecio(int IdPrecio) throws Exception{
        boolean resultado=false;
         ...
         {
             JOptionPane.showMessageDialog(null,"Error en Catalogo:  EliminarPrecio "+pp.getMessage(),"ATENCION",JOptionPane.WARNING_MESSAGE);
         }finally{
             conector.close();
         }
    ...
    public static ArrayList<Precios>  ListadoPrecios() throws Exception{
        ...
        ArrayList<Precios> lista = new ArrayList<Precios>();
         ...
         try{
               ...
               if (respuesta.next()){
                    do {
                        Precios miPunto = new Precios(respuesta.getInt(1),respuesta.getString(2),respuesta.getFloat(3));
                        lista.add(miPunto);
